...
from .views import server_services_view, service_details_view, application_detail_view, application_list_view, metrics_page_view, metrics_data_api, all_servers_plot, metrics_dashboard, metrics_data, check_threshold_view
...
urlpatterns = [
    ...
    path('app/applications/', login_required(application_list_view), name='application_list'),
